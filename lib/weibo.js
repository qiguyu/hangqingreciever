...
exports.getZnzLists = function(cb){
    mysql.getZnzLists(cb);
};
...
exports.getLatest = function(param, cb) {
    mysql._select('micro_blog', 1, param.cnt, 'stock_code,send_time,content', "content_type='zixun' and send_time>0", null, 'send_time desc', function(error, data) {
        if(error) {
            cb('error', error);
        } else {
            cb(null, data);
